...
const newProducts = [
  {
    ...
    description:
      "Samsung Galaxy S25 FE - Hiệu năng cao, màn hình Dynamic AMOLED 2X, chip Snapdragon 8 Elite.",
    stock_quantity: 30,
  },
  {
    category_id: 1,
    ...
    description:
      "Samsung Galaxy S26 Ultra - Flagship đỉnh cao, bút S-Pen, camera 200MP, AI Galaxy.",
    stock_quantity: 20,
  },
  {
    category_id: 1,
    ...
    description:
      "Samsung Galaxy Z Fold7 - Điện thoại gập thế hệ mới, màn hình lớn 7.6 inch.",
    stock_quantity: 15,
  },
  {
    category_id: 1,
    ...
    description:
      "Samsung Galaxy Z Flip7 - Thiết kế gập nhỏ gọn, thời trang và hiện đại.",
    stock_quantity: 25,
  },
  {
    category_id: 1,
    ...
    description:
      "iPhone 17 Pro Max - Chip A19 Pro, hệ thống camera 48MP cải tiến, khung Titanium.",
    stock_quantity: 20,
  },
  {
    category_id: 1,
    ...
    description:
      "iPhone Air - Mỏng nhất trong lịch sử iPhone, thiết kế siêu nhẹ và sang trọng.",
    stock_quantity: 18,
  },
  {
    category_id: 1,
    ...
    description:
      "Xiaomi 15 Ultra - Camera Leica đỉnh cao, Snapdragon 8 Gen 4, sạc nhanh 90W.",
    stock_quantity: 22,
  },
  {
    category_id: 1,
    ...
    description:
      "Xiaomi POCO F8 Pro - Hiệu năng gaming, làm mát hiệu quả, pin 5000mAh.",
    stock_quantity: 35,
  },
  {
    category_id: 1,
    ...
    description:
      "Xiaomi Redmi Note 15 Pro - Tầm trung cao cấp, camera 200MP, pin 5500mAh.",
    stock_quantity: 50,
  },
  {
    category_id: 1,
    ...
    description:
      "Samsung Galaxy S22 Ultra - Bút S-Pen tích hợp, camera 108MP, chip Snapdragon 8 Gen 1.",
    stock_quantity: 10,
  },
];
...
async function addProducts() {
  ...
  for (const p of newProducts) {
    try {
      ...
      console.log(`- Thêm thành công: ${p.product_name} (ID: ${result.insertId})`);
      added++;
    } catch (err) {
      console.error(`- Lỗi ${p.product_name}:`, err.message);
    }
  }
  console.log(`\n- Quá trình thêm sản phẩm hoàn tất: ${added}/${newProducts.length} sản phẩm mới.`);
  process.exit(0);
}
